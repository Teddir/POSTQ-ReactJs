            ...
            <div className="Content" style={{display:'flex', flexDirection:'row', maxHeight: '100px'}}>
                ...
                <div className="bodyRight">
                    <div style={{
                        ...
                        <p style={{
                            fontSize: 20,
                        }}>Let’s create your free account</p>
                        ...
                        <input type="text" name="username" placeholder="your name" style={{
                            marginTop: 10,
                            marginBottom: 15,
                            width: '350px',
                            height: '40px',
                        ...
                        fontSize: 17,
                            ...
                            <button type="submit" onClick="/register" title="Login" placeholder="Login" style={{
                            marginBottom: 10,
                            width: '360px',
                            height: '70px',
                            borderRadius: 4,
